<template>
  <div class="max-w-5xl min-w-[600px] mt-8">
    <div class="flex justify-between gap-2">
      ...
      <ButtonStandard @click.prevent="setNote = true"
        ...
        >
          <tr
            ...
            :class="{
              ...
              ' hover:text-voloblue-100 hover:bg-gray-50 border-b':
          ...
          <tr v-if="expandedRows.includes(index)" :key="note.id">
            ...
            >
              <p
                class="bg-vologray-100 px-4 py-2 mx-4 rounded-md whitespace-pre"
              >
                {{ note.note }}
              </p>
            </td>
            ...
            >
              <div
                class="flex gap-1 mr-2 justify-start"
                v-if="note.user == userStore.user.email"
              >
